...
function routeModel(request) {
  ...
  eligible.sort((a, b) => {
    const score = (capability2) => (request.needsFirstFrame === true ? Number(capability2.firstFrame) : 0) + (request.needsLastFrame === true ? Number(capability2.lastFrame) : 0) + (request.needsAudio === true ? Number(capability2.audio) : 0) + (request.durationSec !== void 0 && request.durationSec <= capability2.maxDurationSec ? 1 : 0);
