...
> 来源：DocsBot「Surreal Image Prompts」、Gemini3Prompt「AI Surrealist Art Prompts」、Pixu「Surrealism Inspired Prompts」、Pixu「Surrealism Style Prompts」。

## 概述

**核心断言**：超现实 = **"不可能的并置成为意义"**——融化物象（达利钟表）、梦境景观、异质元素拼接（拼贴/照片蒙太奇）；超现实承载潜意识/隐喻叙事（衔接 224：风格体系的超现实维度；181：氛围的梦境版）。
...
分层纹理 + 异质元素混合 + 剪切感——**"不同世界在同一画面"**（衔接 232 多主体的超现实版）。
...
```text
"Dalí-style surrealist painting, dreamlike atmosphere, melting objects,
impossible juxtaposition, hyperreal detail, museum-quality"
"photomontage, layered textures, disparate elements blended,
dreamlike collage"
```

### 超现实叙事功能

超现实 = 隐喻视觉化（潜意识/社会批判）——**"不可能的画面"承载"抽象的主题"**（衔接 248 符号学：符号的超现实形态）。
...
**DirectorX 纪律**：并置承载意义；隐喻驱动奇观；分层纹理；属性化防侵权。

## 术语表（中英对照）

| 中文 | English | 说明 |
|---|---|---|
| 超现实主义 | Surrealism | 梦境艺术 |
| 不可能并置 | Impossible Juxtaposition | 异质组合 |
| 照片蒙太奇 | Photomontage | 拼贴合成 |
| 融化物象 | Melting Object | 达利符号 |
| 隐喻视觉化 | Metaphor Visualization | 意义承载 |
| 潜意识 | Subconscious | 梦境主题 |

## 来源

- DocsBot — Surreal Image Prompts：https://docsbot.ai/prompts/creative/surreal-image-prompts
- Gemini3Prompt — AI Surrealist Art Prompts：https://gemini3prompt.com/articles/ai-surrealist-art-prompts/
