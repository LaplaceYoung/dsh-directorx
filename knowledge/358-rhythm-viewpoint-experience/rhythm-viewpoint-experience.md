...
> 来源：OUP「Rhythmic Phrasing in Narrative Film」、PMC「Narrative Theory and Popular Movies」、IBM「Finding the Beat」、Unimi「RITMEx」。

## 概述

**核心断言**：节奏-视点-体验 = **"总参与设计"**——体验节奏（观众感知）；叙事维度（幕结构/剪辑/取景/运动/声音影响参与）；节奏-时机-序列设计=卷入核心；格式塔+神经时间（节奏的神经基础）（衔接 349：三整合的体验版；323：沉浸）。

## 核心概念

### 体验节奏（OUP）

节奏=观众**感知体验**（非仅编辑参数）——**"节奏在人不在剪"**（衔接 349）。

### 叙事五维度（PMC）

幕结构 + 剪辑 + 取景 + 运动 + 声音 → 参与——**"五维度影响卷入"**（衔接 282）。

### 神经节奏（RITMEx）

格式塔组织 + 神经时间（时机科学）→ 视听节奏参与——**"节奏有神经基础"**。
...
"rhythm as perceived + five narrative dimensions + viewpoint alignment"——**节奏+维度+视点**。
...
| 中文 | English | 说明 |
|---|---|---|
| 体验节奏 | Experienced Rhythm | 观众感知 |
| 叙事五维度 | Five Dimensions | 参与结构 |
| 时机科学 | Timing Science | 神经节奏 |
| 格式塔组织 | Gestalt Organisation | 感知分组 |
| 卷入核心 | Engagement Core | 序列设计 |
| 总参与 | Total Engagement | 统一体验 |

## 来源

- OUP — Towards an Account of Rhythmic Phrasing in Narrative Film：https://academic.oup.com/screen/article/66/4/475/8407479
- PMC — Narrative Theory and the Dynamics of Popular Movies：https://pmc.ncbi.nlm.nih.gov/articles/PMC5133278/
