...
> 来源：Picsart「How to Prompt for Specific Art Styles」、Text2Img「Watercolor and Painting Style AI 2026」、ZSky「AI Painting Prompts 100+」、ZSky「AI Painting Style Prompts」。

## 概述

**核心断言**：绘画媒介 = **"技法词汇库"**——水彩（晕染/透明/留白）、油画（厚涂/可见笔触/罩染）、丙烯（厚实/快干感）、水粉（不透明/哑光）；**技法词进提示词 = 画作质感**（衔接 224：媒介风格深化；250：画作的氛围）。
...
```
晕染（Wash）、透明层（Transparent Layers）
留白（White Space）、纸纹（Paper Texture）
柔和边缘（Soft Edges）
```
...
```
厚涂（Impasto）、可见笔触（Visible Brushwork）
罩染（Glazing）、画布纹（Canvas Texture）
色调过渡（Tonal Transition）
```
...
```text
"oil painting, impasto technique, visible brushwork, canvas texture,
museum-quality, gallery lighting"
"watercolor, soft washes, transparent layers, paper texture,
delicate color bleed"
```

### 媒介情绪

水彩=轻盈/梦幻，油画=厚重/经典——**媒介承载情绪**（衔接 270 风格情绪）。
...
**DirectorX 纪律**：技法词汇定画作质感；单媒介不混；纹理真实；情绪随媒介。
...
| 罩染 | Glazing | 透明层叠色 |
| 晕染 | Wash | 水彩大面铺色 |
| 色彩渗透 | Color Bleed | 水彩交融 |
| 画布纹理 | Canvas Texture | 布纹 |
| 画作感 | Painterly Quality | 媒介质感 |

## 来源

- Picsart — How to Prompt for Specific Art Styles with AI：https://picsart.com/tutorials/how-to-prompt-for-specific-art-styles-with-ai/
- Text2Img — Watercolor and Painting Style AI Images 2026：https://www.text2img.pro/watercolor-painting-style-ai-2026/
