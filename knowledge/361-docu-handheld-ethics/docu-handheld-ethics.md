...
> 来源：Emory「Documentary Dilemmas」、IDFA「Documentary Distortion: Code of Ethics」、NORC「Ethical Documentary Filmmaking」、GovInfo「Deepfake Harms」。

## 概述

**核心断言**：纪实-手持-伦理 = **"在场真实×关怀义务"**——知情同意+参与者自主+编辑/AI 透明；**关怀义务文档**（补偿/编辑控制/放映参与）；再现/素材/AI 不扭曲真实（衔接 352：纪实美学；166：伦理框架）。
...
文档化：补偿/编辑控制/放映参与——**"义务落纸"**（衔接 191 清权文档化）。

### 不扭曲（IDFA）

再现/素材/AI 元素不扭曲真实（标注/边界）——**"真实有边界"**（衔接 139 再现标注）。
...
"informed consent + duty-of-care document + transparent AI labeling"——**同意+义务+透明**。
...
纪实实践（衔接 139/145/166/191/352）：

```text
同意 → 义务文档 → 标注 → 制作 → 审查 → 放映
```

**DirectorX 纪律**：知情同意；义务落纸；AI 透明；真实有边界。

## 术语表（中英对照）

| 中文 | English | 说明 |
|---|---|---|
| 知情同意 | Informed Consent | 参与权利 |
| 关怀义务 | Duty of Care | 责任文档 |
| 编辑控制 | Editorial Control | 参与者权力 |
| 再现标注 | Reenactment Label | 真实边界 |
| 参与放映 | Screening Involvement | 共同决定 |
| 伦理审查 | Ethics Review | 风险管控 |

## 来源

- Emory — Documentary Dilemmas: Ethics of Nonfiction Storytelling：https://news.emory.edu/stories/2025/11/documentary-dilemmas-examining-ethics-nonfiction-storytelling
- IDFA — What to Do About Documentary Distortion：https://www.documentary.org/feature/what-do-about-documentary-distortion-toward-code-ethics
