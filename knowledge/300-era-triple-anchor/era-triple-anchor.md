...
> 来源：Tandfonline「Restoring Cultural Identity」、EWU「The Reel Truth: Historical Accuracy」、PremiumBeat「Filmmaker's Guide to Period Piece」、Film-History「The Authenticity Feeling」。

## 概述

**核心断言**：年代戏真实 = **三锚锁定**——表演语域（291 年代表演）+ 场景细节（美术设计 222/287）+ 声音锚定（音乐/环境音带年代感）；**"真实性感觉"**（Authenticity Feeling）优先于绝对史实（叙事权衡）（衔接 203：时代锁定三通道版）。
...
```
① 表演锚：年代表演语域（291）
② 场景锚：美术/服装/道具（222/203）
③ 声音锚：年代音乐/环境（269/295）
```

### 真实性感觉（Film-History）

**真实 = 有效的历史体验**（观众相信）非逐字史实——**叙事目标可覆盖细节精确**（衔接 282 三整合）。

### 时期片方法（PremiumBeat）

美术设计为核心（传达年代）+ 音乐/声音锚定氛围——**视觉+听觉双年代信号**。
...
"1930s: declamatory acting + Art Deco sets + jazz era soundscape"——**三通道同年代**。
...
年代戏（衔接 203/222/269/291）：

```text
年代 → 三锚设计 → 生成 → 真实性校验
```

**DirectorX 纪律**：三锚同年代；真实性感觉优先；视觉+听觉双信号；体验校验。

## 术语表（中英对照）

| 中文 | English | 说明 |
|---|---|---|
| 三锚锁定 | Triple Anchor | 表演场景声音 |
| 真实性感觉 | Authenticity Feeling | 有效历史体验 |
| 年代声音锚 | Era Sound Anchor | 音乐环境 |
| 美术核心 | Production Design Core | 视觉年代 |
| 叙事权衡 | Narrative Trade-off | 真实vs故事 |
| 双信号 | Dual Signal | 视+听 |

## 来源

- Tandfonline — Restoring Cultural Identity in a Global World：https://www.tandfonline.com/doi/full/10.1080/17503175.2025.2461907
- EWU — The Reel Truth: Historical Accuracy in Film：https://dc.ewu.edu/cgi/viewcontent.cgi?article=1653&context=theses
