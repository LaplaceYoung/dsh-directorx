...
> 来源：NumberAnalytics「Golden Ratio in Film」、FilmDaft「What Is the Golden Ratio」、Purpose Studio「Golden Ratio in Film & Photography」、LinkedIn「Rule of Thirds vs Golden Ratio vs Phi Grid」。

## 概述

**核心断言**：黄金比例构图 = **三分法的电影感升级**——Phi 网格中央带按 1.618 分割，主体置于交点产生微妙偏置平衡（比三分法更"自然"）。**用于关键镜头（boss 揭示/开场）**，必要时刻意打破（传达不安/混乱）。
...
|---|---|---|
| 三分法 | 等分 3×3 | 基础平衡 |
| Phi 网格 | 1:1.618 分割 | 微妙偏置/电影感 |

### 适用场景

- **关键镜头**：boss 揭示/开场/情绪高点
- **引导视线**：沿黄金螺旋（自然扫视路径）
- **打破规则**：刻意失衡传达不安（衔接 158 张力）
...
```text
"subject positioned at the golden ratio intersection, phi grid composition,
subtle off-center balance, cinematic"
```

### 黄金螺旋引导

主体沿螺旋起点，视线自然扫过辅助元素到终点——**构图引导注意力**（衔接 192 负空间协同）。
...
```text
镜头重要性判断 → Phi 网格选型（关键镜头）
  → 主体交点/螺旋引导 → 生成
  → 构图校验（192 负空间协同）
  → 必要时打破（158 张力）
```

**DirectorX 纪律**：Phi 网格=电影感升级；关键镜头用；螺旋引导视线；刻意打破传张力。
...
| Phi 网格 | Phi Grid | 黄金分割网格 |
| 黄金螺旋 | Golden Spiral | 自然扫视路径 |
| 偏置平衡 | Off-Center Balance | 微妙失衡 |
| 电影感 | Cinematic Feel | 自然平衡 |
| 刻意打破 | Intentional Break | 张力表达 |

## 来源

- NumberAnalytics — Golden Ratio in Film：https://www.numberanalytics.com/blog/golden-ratio-in-film
- FilmDaft — What Is the Golden Ratio? A Guide for Filmmakers：https://filmdaft.com/what-is-the-golden-ratio-definition/
